...
Release `v2.2.0` publishes:

```text
world-capabilities-v2.2.0-deterministic.tar.gz
world-capabilities-v2.2.0-deterministic.tar.gz.sha256
```

The stable release URL is:

```text
https://github.com/tkersey/world-capabilities/releases/download/v2.2.0/world-capabilities-v2.2.0-deterministic.tar.gz
```
...
```sh
(cd .. && shasum -a 256 -c world-capabilities-v2.2.0-deterministic.tar.gz.sha256)
