...
test("network authority labels must be arrays", async () => {
  const root = await mkdtemp(join(tmpdir(), "world-network-authority-shape-pack-"));
  try {
    const dir = join(root, "pack");
    await mkdir(dir);
    await writeFile(join(dir, "adapter.mjs"), "import builtin from \"node:http\";\nexport default builtin;\n");
    await expect(verifySelfContained({
      name: "network-authority-shape-pack",
      dir,
      manifest: {
        artifacts: [{ path: "adapter.mjs" }],
        authorityLabels: "network.http",
...
test("Node TypeScript sidecar module checks ignore type-only syntax", async () => {
  for (const [name, artifactPath, source] of [
    ...
    ["mts-local-commonjs-name-bindings", "sidecar.mts", "const module = { value: \"ok\" };\nconst __dirname = \"local\";\nfunction f(exports) { return exports; }\nprocess.stdout.write(module.value + __dirname.length + f(\"\"));\n"],
    ["mts-bare-typeof-commonjs-names", "sidecar.mts", "const ok = typeof module === \"undefined\" && typeof exports === \"undefined\";\nprocess.stdout.write(String(ok));\n"],
...
test("Node TypeScript sidecars reject incompatible module syntax", async () => {
  for (const [name, artifactPath, source, helperPath, helperSource] of [
    ...
    ["mts-commonjs-typeof-module-member", "sidecar.mts", "void (typeof module.exports);\nprocess.stdout.write(\"ok\");\n", "helper.cjs", "module.exports = true;\n"],
    ["mts-nested-block-local-exports-member", "sidecar.mts", "if (true) { const exports = {}; }\nexports.foo = 1;\nprocess.stdout.write(\"ok\");\n", "helper.cjs", "module.exports = true;\n"],
    ["mts-commonjs-plain-exports", "sidecar.mts", "void exports;\nprocess.stdout.write(\"ok\");\n", "helper.cjs", "module.exports = true;\n"],
    ["mts-commonjs-plain-module", "sidecar.mts", "void module;\nprocess.stdout.write(\"ok\");\n", "helper.cjs", "module.exports = true;\n"],
    ["mts-commonjs-dirname", "sidecar.mts", "void __dirname;\nprocess.stdout.write(\"ok\");\n", "helper.cjs", "module.exports = true;\n"]
  ]) {
